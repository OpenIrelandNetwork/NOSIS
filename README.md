...
Below you will find the presentations that were shared, along with the available session recordings.

Unfortunately, due to an equipment issue in one of the event rooms, we were unable to capture audio for a small number of sessions. We sincerely apologise to the affected speakers and viewers. Where possible, we are working to share any related materials to ensure the content remains accessible.
...
**Descriptor:** Real-world and strategic perspectives on how open source enables collaboration, open research, and global leadership in Open Source AI.

#### Open Source for Collaboration (Panel)
**Speakers:**  
- Addie Cobb, Varro (Moderator)  
- Wolfgang Gehring, Mercedes-Benz Tech Innovation  
- Frank Kelly, Ericsson  
...
#### How to Close the Open Source Skills Gap
**Speakers:**  
- Clare Dillon – Open Ireland Network (Moderator)  
...
**Speakers:**  
- Addie Cobb – Varro (Moderator)  
- Brian Farrell – Securitix  
- Sebastian Raible – EU Open Source Business Association  
- Neil Smyth – Alkemio  
- Phil Weir – Flax & Teal
...
**Descriptor:** In-depth technical and policy-focused sessions on regulation, AI, software trust, and public-sector open source practice.
...
**Descriptor:** Strategic panels exploring innovation, sectoral adoption, and Ireland’s opportunity in open source and open source AI.
...
**Speakers:**  
- Carina Tullander – Open Logistics Foundation  
- David Gonzalez – Cloudsmith  
- Dermot Casey – IRDG (Moderator)  
- Phil Robb – Ericsson  
- Wolfgang Gehring – Mercedes-Benz Tech Innovation
...
**Speakers:**  
- Kathryn Lynch – Innovate Ireland (Moderator)  
- Ivan Jennings – AI2  
- Noel O’Connor – INSIGHT  
...
#### Open Source in Financial Services (Panel)
**Speakers:**  
- Pooyan Chegini – NatWest  
- Nick Preston – Fidelity  
- Anton Walley – Bank of Ireland (Moderator)  
- Kalle Westerling – Chainguard

*A discussion on how highly regulated financial organisations are engaging with open source to address their software development needs.*

---

### Deep Dive Talks (Afternoon)

**Descriptor:** Applied and technical talks focused on business models, AI platforms, and licensing foundations.
...
**Descriptor:** Practitioner-led sessions sharing hands-on lessons from global ecosystems and successful open source projects.
...
**Descriptor:** Closing reflections and synthesis of the day’s discussions.
